...
class MyTheme {
  ...
  static const Color accent_color = Color.fromRGBO(128, 0, 128, 1);
  static const Color accent_color_shadow =
      Color.fromRGBO(128, 65, 128, .40); // this color is a dropshadow of
  static Color soft_accent_color = Color.fromRGBO(254, 234, 209, 1);
  static Color splash_screen_color = Color.fromRGBO(128, 0, 128, 1); // if not sure , use the same color as accent color
  ...
  //---------------
  static const Color brick_red = Color.fromRGBO(128, 0, 128, 1);
  static const Color cinnabar = Color.fromRGBO(128, 0, 128, 1);
